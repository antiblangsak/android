...
public class DPGKNasabahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dpgk_nasabah);
        ...
        Call call = apiInterface.getAllDPGKFamilyMembers(token, familyId);
            ...
            public void onResponse(Call call, Response response) {
                ...
                if (statusCode == 200) {
                        ...
                        if (unregistered == null || unregistered.length() == 0) {
                            ...
                            addNewNasabah.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent myIntent = new Intent(DPGKNasabahActivity.this, DPGKAddNasabahActivity.class)
                    ...
                    try {
                        ...
                        startActivity(new Intent(DPGKNasabahActivity.this, LoginActivity.class)
