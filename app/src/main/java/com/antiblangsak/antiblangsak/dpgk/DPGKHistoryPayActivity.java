...
public class DPGKHistoryPayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dpgkhistory_pay);
        ...
        Typeface customFont = Typeface.createFromAsset(DPGKHistoryPayActivity.this.getApplicationContext().getAssets(), "fonts/Comfortaa-Bold.ttf");
            ...
            public void onResponse(Call call, Response response) {
                ...
                if (statusCode == 200) {
                    ...
                    try {
                        ...
                        startActivity(new Intent(DPGKHistoryPayActivity.this, LoginActivity.class)
            ...
            public void onClick(View v) {
                ...
                call.enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) {
                        ...
                        if (statusCode == 201) {
                            startActivity(new Intent(DPGKHistoryPayActivity.this, DPGKHistoryActivity.class)
