...
public class DPGKHistoryClaimActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dpgkhistory_claim);
        ...
        Typeface customFont = Typeface.createFromAsset(DPGKHistoryClaimActivity.this.getApplicationContext().getAssets(), AppConfig.BOLD_FONT);
            ...
            public void onResponse(Call call, Response response) {
                ...
                if (statusCode == 200) {
                    ...
                    try {
                        ...
                        startActivity(new Intent(DPGKHistoryClaimActivity.this, LoginActivity.class)
