...
public class DPGKAddNasabahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dpgk_add_nasabah);
        ...
        nasabahListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (nasabahModel.isSelected()) {
                    ...
                    view.setBackground(new ColorDrawable(getResources().getColor(R.color.dpgk_nasabah_checked_color)));
                } else {
        ...
        btnDaftarkan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ids.isEmpty()) {
                    ...
                    Call call = apiInterface.registerClient(token, userId, ids, AppConstant.DPGK_SERVICE_ID_INTEGER);
                        ...
                        public void onResponse(Call call, Response response) {
                            ...
                            if (statusCode == 201) {
                                try {
                                    ...
                                    startActivity(new Intent(DPGKAddNasabahActivity.this, DPGKNasabahActivity.class)
                                ...
                                try {
                                    ...
                                    startActivity(new Intent(DPGKAddNasabahActivity.this, LoginActivity.class)
